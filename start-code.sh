...
img_output="deepexi/project"      # output image tag
...
sudo mv $proj_home/project-provider/target/project-*.jar $proj_home/project-provider/target/demo.jar # 兼容所有sh脚本
